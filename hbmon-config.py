...
PEER_URL        = 'https://raw.githubusercontent.com/tombolptt/KT25ARI/main/peer_ids.json'
SUBSCRIBER_URL  = 'https://raw.githubusercontent.com/tombolptt/KT25ARI/main/subscriber_ids.json'
