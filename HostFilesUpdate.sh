...
curl --fail -o ${DMRHOSTS} -s https://raw.githubusercontent.com/tombolptt/KT25ARI/main/DMR_Hosts.txt
...
curl --fail -o ${DMRIDFILE} -s https://raw.githubusercontent.com/tombolptt/KT25ARI/main/DMRIds.dat
